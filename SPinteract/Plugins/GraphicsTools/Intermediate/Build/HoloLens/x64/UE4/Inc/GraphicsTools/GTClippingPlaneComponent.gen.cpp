...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGTClippingPlaneComponent_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGTClippingPlaneComponent_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UGTClippingPlaneComponent()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UGTClippingPlaneComponent_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UGTClippingPlaneComponent, 1121403410);
	template<> GRAPHICSTOOLS_API UClass* StaticClass<UGTClippingPlaneComponent>()
	{
		return UGTClippingPlaneComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UGTClippingPlaneComponent(Z_Construct_UClass_UGTClippingPlaneComponent, &UGTClippingPlaneComponent::StaticClass, TEXT("/Script/GraphicsTools"), TEXT("UGTClippingPlaneComponent"), false, nullptr, nullptr, nullptr);
